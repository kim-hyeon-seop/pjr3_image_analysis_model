...
class Exam(QWidget, form_window):
    def __init__(self):
        ...
        self.model_02 = load_model('models/age_gender_tf21.h5')
    ...
    def image_open_slot(self):
        ...
        while self.flag:
            ...
            categories_kor = ['화내는', '누군가를 깔보는', '역겨워하는', '벌벌 떠는',
                              '기뻐하는', '슬퍼하는', '깜짝 놀라는']
            # 성별, 감정은 64x64 사이즈의 이미지 데이터(img_01)를 사용하고
            # 나이는 48x48 사이즈의 이미지 데이터(img_02)를 사용합니다.
            ...
            # 성별예측 2: 현섭님의 모델 사용(성별예측 1 주석처리하고, 성별예측 2 주석 풀어서 사용하시면 됩니다)
            sex_f = ['Male', 'Female']
            ...
            # 감정 예측
            # self.lbl_emotion.setText('현재' + categories[np.argmax(predict_value_03[-1])] + '한 상태입니다')
